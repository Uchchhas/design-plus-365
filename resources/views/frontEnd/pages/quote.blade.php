    ...
    <main class="quote-page">
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-sm-5">
                        <h5 class="text-white font-weight-normal wow animate__animated animate__fadeInUp mb-4">GET A
                            FREE QUOTE</h5>
                        <h1 class="primary-text font-size-40 font-weight-500 wow animate__animated animate__fadeInUp mb-4">
                            You Think, we build!</h1>
                        <h5 class="text-white text-justify font-weight-light wow animate__animated animate__fadeInUp mb-4">
                            Do you want to portray your thoughts into reality? Then approach us, we have a record of
                            doing more than 700+ startups. Share your ideas with our team and we will shape it into a
                        ...
                        <div class="quick-chat d-flex justify-content-between">
                            ...
                            <div class="chat-item text-center d-flex flex-column justify-content-center wow animate__animated animate__fadeInUp"
                                 data-wow-delay="0.2s">
                                <a href="https://msng.link/o/?https://www.facebook.com/designplus365=fm" target="_blank"
                                   class="text-white">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        @endif
                        <form action="{{url('/contact-us')}}" method="post" name="form" class="contact-form"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                                    <input class="btn btn-app app-color mr-2" type="submit" name="submit" value="Send">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <section id="contactPageSectionTwo" class="contact-page-section-two">
            <div class="container">
                ...
                <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-center social-medias">
                    <div class="text-center d-flex flex-column justify-content-center single-media wow animate__animated animate__fadeInUp"
                         data-wow-delay="0.1s">
